...
# Assuming structure: .../data/plugins/astrbot_plugin_matrix_daily_analysis/scripts/mock_pdf_gen.py
# We need to go up 4 levels to reach 'AstrBot-master' root which contains the 'astrbot' package
# data/plugins/astrbot_plugin_matrix_daily_analysis/scripts -> ... -> AstrBot-master
